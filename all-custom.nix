...
let
  ...
  python3Packages = import ./development/python-modules/python-packages.nix { inherit buildPythonPackage; callPackage = pkgs.python3Packages.callPackage; };
...
mergeAttrs nodePackages {
  inherit python3Packages perlPackages java-buildpack-memory-calculator sqlint;
