...
let
  sources = {
    ...
    "@jupyterlab/builder-3.0.2" = {
      ...
      version = "3.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@jupyterlab/builder/-/builder-3.0.2.tgz";
        sha512 = "IbP6uCNOfZmwbknNnqGajqkPe3KathQD1zhGMuNxHm92fgE7dzY+hJ9tPWxRYicBWkOUuuF0VAEvwNyYm2bpsA==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@jupyterlab/builder-3.0.2" // {
        dependencies = [
